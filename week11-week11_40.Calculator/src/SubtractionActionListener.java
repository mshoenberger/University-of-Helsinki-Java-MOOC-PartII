 ...
 * @author Neptrocity
 */
public class SubtractionActionListener implements ActionListener {
    ...
    public SubtractionActionListener(GraphicCalculator calcUI){
    ...
    public void actionPerformed(ActionEvent ae){
        if(this.calc.isValidInput()){
            ...
            this.logic.subtractValue(valueToAdd);
